 ...
 */
class LiveSelect extends LivewireSelect
{
    public $name;
    public $placeholder;
    ...
    public function styles()
    {
        return [
            ...
            'search'                 => 'relative w-100 h-full',
            'searchInput'            => 'block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm',
            'searchOptionsContainer' => 'absolute top-0 left-0 mt-10 w-full z-10 overflow-auto h-40 divide-y',

            'searchOptionItem'         => 'p-2 hover:bg-gray-100 cursor-pointer text-sm text-black hover:bg-indigo-600 hover:text-white',
            'searchOptionItemActive'   => 'bg-indigo-600 font-medium text-white',

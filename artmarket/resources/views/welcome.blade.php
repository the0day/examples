...
<div class="
    p-3 p-8 p-2 top-0 left-0 mt-12 z-10 h-40 h-80 h-20 h-10 h-4 w-4 overflow-auto divide-y
    rounded border w-full appearance-none bg-white flex items-center border-gray-100
    relative absolute  hover:bg-gray-100 cursor-pointer text-sm bg-indigo-600
    text-gray-900 text-left text-gray-500  text-white font-medium text-gray-600 text-xs text-gray-600
    datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 leading-9 rounded-lg dark:text-white day disabled cursor-not-allowed"></div>
</body>
</html>

            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                @guest
                    <div class="md:flex items-center justify-end md:flex-1 lg:w-0 ml-8 inline-flex">
                        <a href="#"
                           class="whitespace-nowrap sm:text-base text-white px-3 py-2 rounded-md hover:bg-gray-700 text-sm"
                           onclick="showModal('auth')">
                            @lang('auth.signin')
                        </a>
                        <a href="#"
                           class="whitespace-nowrap justify-center border border-transparent rounded-md bg-yellow-400 hover:bg-yellow-500 px-2 py-1 text-sm sm:text-base">
                            @lang('auth.signup')
                        </a>
                    </div>
                @endguest

                            ...
                            @foreach($this->columns as $index => $column)
                                ...
                                @elseif($column['type'] === 'checkbox')
                                    @unless($column['hidden'])
                                        <div class=" table-cell h-10 w-32 py-4 flex justify-center overflow-hidden align-top px-6 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider focus:outline-none">
                                    ...
                                    @endunless
                                @else
                                    @include('livewire.datatables.header-no-hide', ['column' => $column, 'sort' => $sort])
                                @endif
                            @endforeach
                        </div>
